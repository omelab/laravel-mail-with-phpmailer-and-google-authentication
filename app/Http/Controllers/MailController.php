...
class MailController extends Controller
{
    ...
    {
        $this->email            = 'infobasedevelop@gmail.com'; // SELECTED_USER_EMAIL_ID
        $this->email_name       = 'Infobase Development';     // SELECTED_USER_NAME
    ...
    public function doSendEmail(Request $request)
    {
        ...
        try {
            ...
            $mail->addAddress('a.bakar87@gmail.com', 'Abu Bakar Siddique');
